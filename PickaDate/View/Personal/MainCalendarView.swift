...
struct MainCalendarView: View {
    ...
    @StateObject private var groupViewModel = GroupScheduleViewModel() // 그룹 데이터를 위한 ViewModel 추가
        ...
        NavigationView {
            ...
            .onAppear {
                ...
                for groupID in user.joinedGroups {
                    groupViewModel.fetchGroupSchedules(groupID: groupID)
                }
            }
...
extension MainCalendarView {
    ...
    func createEvents() -> [Event] {
        ...
        for schedule in groupViewModel.groupSchedule {
