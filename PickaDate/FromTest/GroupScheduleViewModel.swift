...
//                        } ?? []
//                        print("[L]멤버 일정 가져오기 성공: \(self.userSchedule.count)개")
//                        completion()
//                    }
//                }
//        }
...
//                    
//                    // 모든 개인 일정을 메모리에 로드
//                    let allSchedules = snapshot?.documents.compactMap { doc -> PDUserSchedule? in
//                        try? doc.data(as: PDUserSchedule.self)
//                    } ?? []
//                    
//                    // 각 날짜별로 일정 상태 계산
...
//    
//    
//    func addUserSchedule(userID: String, title: String, content: String, groupID: [String], schedule: [UserTimeSlot], personalColor: String) {
