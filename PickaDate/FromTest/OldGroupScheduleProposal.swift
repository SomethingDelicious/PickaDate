...
struct OldGroupScheduleProposal: Identifiable, Codable {
    ...
    var proposals: [OldProposal]    // 일정 후보 목록
    var status: OldProposalStatus   // 제안 상태
}

struct OldProposal: Identifiable, Codable {
...
enum OldProposalStatus: String, Codable {
    case pending    // 진행 중
    case confirmed  // 확정됨
    case canceled   // 취소됨
}
